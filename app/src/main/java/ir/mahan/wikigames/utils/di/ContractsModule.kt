...
import ir.mahan.wikigames.ui.favorites.FavoritesContracts
...
object ContractsModule {
    ...
    @Provides
    fun provideGFavoritesContracts(fragment: Fragment): FavoritesContracts.View =
        fragment as FavoritesContracts.View
